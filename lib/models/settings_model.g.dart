...
void _settingsSerialize(
  ...
  writer.writeLong(offsets[1], object.lowStockThreshold);
}
...
Settings _settingsDeserialize(
  ...
  final object = Settings(
    ...
    lowStockThreshold: reader.readLongOrNull(offsets[1]) ?? 10,
  );
  return object;
}
...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByLowStockThreshold() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lowStockThreshold', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByLowStockThresholdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQuerySortThenBy
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByLowStockThreshold() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lowStockThreshold', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByLowStockThresholdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lowStockThreshold', Sort.desc);
    });
  }
...
extension SettingsQueryWhereDistinct
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByLowStockThreshold() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQueryProperty
  ...
  QueryBuilder<Settings, int, QQueryOperations> lowStockThresholdProperty() {
    return QueryBuilder.apply(this, (query) {
